...
class Model(torch.nn.Module):
    def __init__(self):
        ...
        self.STFT_layer = Spectrogram.STFT(sr=44100, n_fft=n_fft, freq_bins=freq_bins, fmin=50, fmax=6000, freq_scale='linear', pad_mode='constant', center=True)
...
with open('./result_dict/LinSpec/'+filename+ '_e-{}_w-{}_n_fft-{}_fb-{}'.format(epochs, window, n_fft, freq_bins), 'wb') as f:

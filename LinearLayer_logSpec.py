...
class Model(torch.nn.Module):
    def __init__(self):
        ...
        self.STFT_layer = Spectrogram.STFT(sr=44100, n_fft=n_fft, fmin=50, fmax=6000, freq_scale='log', pad_mode='constant')
...
with open('./result_dict/'+filename+ '_e-{}_w-{}_n_fft-{}'.format(epochs, window, n_fft), 'wb') as f:
